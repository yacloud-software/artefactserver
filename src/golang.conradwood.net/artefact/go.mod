...
require (
	...
	golang.conradwood.net/apis/buildrepo v1.1.2951
	golang.conradwood.net/apis/common v1.1.3132
	golang.conradwood.net/apis/gitserver v1.1.2951
	golang.conradwood.net/apis/h2gproxy v1.1.2951
	golang.conradwood.net/apis/objectauth v1.1.2951
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3132 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.3132 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3132 // indirect
